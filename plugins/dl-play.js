...
let handler = async (m, { conn, text }) => {
  ...
  let loadingMsg = await m.reply("⏳ *Jinwoo-v4 Bot is searching for your song... Please wait...*");
  ...
  try {
    ...
    let caption = `🎧 *Jinwoo-v4 Bot - Music Download* 🎶

📌 *Title:* ${songData.title}
👤 *Artist:* ${songData.artist}
🎵 *Status:* ✅ Success
🚀 *𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 © ᴍᴀʟᴠɪɴ ᴛᴇᴄʜ*`;
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: '263780166288@newsletter',
    ...
    m.reply("✅ *Jinwoo-v4 Bot successfully delivered your audio! Enjoy 🎶*");
